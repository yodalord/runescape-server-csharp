...
namespace RunescapeServer.definitions
{
    public class ItemData
    {
	    ...
	    public static int getUnNotedItem(int itemId) {
            /*
             * TODO: Fix this method it's used by Grand Exchange
             * It's pretty ugly and in some cases works on luck alone
             * sometimes 3 items with same name and 2 unnoted, it 
             * may pick out the wrong item
             */
