...
using RunescapeServer.minigames;
    ...
    class Server
    {
        ...
        public static void gameThread()
        {
            while (isRunning)
            {
                ...
                {
                    Console.Title = "Runescape 530 C# Server [Players: " + players.Count + "][Connections: " + connections.Count + "]";
                    lastInfoTime = curTime;
                    toggledStats = true;
                }
                else if (curTime - lastInfoTime >= 4000 && toggledStats)
                {
                    Console.Title = "Runescape 530 C# Server [Events Running: " + events.Count + "]";
                    lastInfoTime = curTime;
                    toggledStats = false;
                }
        ...
        public static void eventProcessingThread() {
            ...
            */
            ...
            /*
             * TODO: Is it a good a idea to put eventProcessing in a seperate thread?
             * Even though it's a good idea to process events in a seperate thread or even multiple threads.
             * In our design seems there are a few bad designs with player/npc updating. One example.
             * Say a DeathEvent is triggered.. since eventProcessing can be done at any time.
             * It will not synchronize properly with Game Loop Thread,
             * Say a NPC is getting removed from screen in Game Loop, 
             * While DeathEevent causes a respawn to happen.
             * and a few players already removed the NPC the others who haven't removed it yet.
             * it will respawn for the players causing visual problems and maybe client crashes.
             * This actually happened and I had to quickfix the DeathEvent which still isn't a solid fix.
             */
