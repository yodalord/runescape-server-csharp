...
namespace RunescapeServer.util
{
     ...
     */
        ...
        public static double randomDouble(int maxNumber)
        {
            //Less precise version. (Used for solid damage values etc..)
            //TODO: Will never equal maxNumber no matter how much you call it.
            return rnd.NextDouble() * maxNumber;
        }

        public static double randomDouble(double maxNumber)
        {
            //More precise version. (Used for defense calcutions)
            //TODO: Will never equal maxNumber no matter how much you call it.
            return rnd.NextDouble() * maxNumber;
        }


        public static double randomDouble(int minNumber, int maxNumber)
        {
            //TODO: Will never equal maxNumber no matter how much you call it.
            return rnd.NextDouble() * (maxNumber - minNumber) + minNumber;
        }
